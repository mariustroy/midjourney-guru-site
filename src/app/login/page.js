    ...
    <section className="bg-[#0D1A0E] text-[var(--brand)] py-16 md:py-24">
      <div className="mx-auto max-w-screen-lg px-6 lg:px-8
        ...
        <div className="text-center space-y-6">
          <h3 className="text-lg md:text-4xl lg:text-4xl font-elanor font-[200]">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 xl:gap-32 items-center mt-10 lg:mt-24 xl:mt-32">
          ...
          <div className="space-y-5 md:order-first relative z-20
            ...
            <h3 className="text-xl md:text-4xl lg:text-4xl font-elanor font-[200]">
  ...
  return (
    <section className="bg-[#0F1F11] text-[var(--brand)] py-16 md:py-24">
      <div className="mx-auto max-w-screen-lg px-6 lg:px-8 text-center space-y-6">
        <h3 className="text-xl md:text-4xl font-elanor lg:text-4xl font-[200]">In depth Video Tutorials</h3>
  ...
  return (
    <section className="bg-[#0F1F11] text-[var(--brand)] py-16 md:py-24">
      <div className="mx-auto max-w-screen-md px-6 lg:px-8">
        <h3 className="text-center text-xl lg:text-4xl md:text-4xl font-elanor font-[200] mb-10">
          FAQs
        </h3>
